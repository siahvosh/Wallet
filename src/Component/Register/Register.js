...
import './../../i18n'; // حتما فایل i18n.js را وارد کنید
            ...
            <Card style={{ width: '40%', scale: '1.8'}}>
                <Grid2 container spacing={2}>
                    <Grid2 sx={{ display: { xs: 'none', sm: 'none', md: 'block'} }}  size={{ xs: 12, sm: 12, md: 7 }} style={{background: '#1E201E', padding: '10px'}} >
                        <Button onClick={() => changeLanguage(  i18n.language === 'fa' ?  'fa' :  'en')}> {i18n.language === 'fa' ? 'فارسی' : 'انگلیسی'}</Button>

                        <div style={{ position: "relative", top: '50%', left: '50%', transform:  'translate(-50%, -50%)'}}>
                            <Grid2 size={12}>
                                  <span style={{color: 'white', fontSize: '.8rem', textTransform: 'capitalize', fontWeight: '700'}}>
                                      {t('register.description.title')} {i18n.language}
                                  </span>
                            </Grid2>
                            <Grid2 size={12}>
